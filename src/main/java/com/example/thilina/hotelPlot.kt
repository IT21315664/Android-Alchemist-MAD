...
class hotelPlot : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hotel_plot)
...
//validation part
        ...
        val employee = EmployeeModel(empId,empName,empEmail,empPhone,empRes,empReg,empHotel,empComEmail,empFloor,empDes)
